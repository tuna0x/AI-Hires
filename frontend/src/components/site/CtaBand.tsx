      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-primary p-10 lg:p-14 text-primary-foreground shadow-elegant">
          ...
          <div className="relative grid lg:grid-cols-[1.4fr_1fr] gap-8 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold tracking-tight">Analyze your CV. Practice your interview.</h2>
              <p className="mt-3 text-lg opacity-90 max-w-xl">A focused career toolkit — built for serious candidates. Free to start, no credit card needed.</p>
            </div>
            <div className="flex flex-wrap gap-3 lg:justify-end">
              <Button asChild size="lg" className="bg-background text-foreground hover:bg-background/90 h-12 px-7 text-base font-semibold rounded-xl">
                <Link to="/cv-analysis">Analyze CV <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
